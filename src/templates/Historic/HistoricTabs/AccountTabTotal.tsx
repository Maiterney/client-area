    ...
    const headerSkeleton = () => {
        return (
            <div className={styles.inactive}>
                ...
                <span className={`${styles.status}`}><Skeleton height="2rem" width='6rem' ></Skeleton></span>
                    ...
                    <Accordion  className='accordion'>
                        {
                            listMonths.map((item: any) => {
                                if (yearController.loading) {
                                    return (
                                        <AccordionTab header={headerSkeleton()} key={item.month} />
                                    )
                                }
                                ...
                                if (bills[item.month]) {
                                    ...
                                    return <AccordionTab header={headerNotAccount(item)} disabled key={item.month}/>  
                                }
                            })
